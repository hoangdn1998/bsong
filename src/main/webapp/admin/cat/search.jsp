...
<div id="page-wrapper">
    <div id="page-inner">
        ...
        <%
        	...
        	if("1".equals(err)){
        		out.print("<span style=\"color: red; font-weight: bold; padding: 5px; \">Không tìm thấy danh mục!</span>");
        	}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button previous disabled" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a href="<%=request.getContextPath()%>/admin/cat/search?page=<%=currentPage-1%>&search_cat=<%=name%>">Trang trước</a></li>
                                             <% 
                                            String active = "";
                                            ...
                                            %>
                                            <li class="paginate_button <%=active%>" aria-controls="dataTables-example" tabindex="0"><a href="<%=request.getContextPath()%>/admin/cat/search?page=<%=i%>&search_cat=<%=name%>"><%=i%></a></li>
											<%} %>
                                            <li class="paginate_button next" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_next"><a href="<%=request.getContextPath()%>/admin/cat/search?page=<%=currentPage+1%>&search_cat=<%=name%>">Trang tiếp</a></li>
                                        </ul>
                                    </div>
                              <%} %>
                                </div>
